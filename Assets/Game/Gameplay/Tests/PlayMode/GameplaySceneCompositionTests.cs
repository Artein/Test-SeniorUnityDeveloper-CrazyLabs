...
public sealed class GameplaySceneCompositionTests : BaseGameplayScenePlayModeFixture
{
    ...
    public IEnumerator given_GameplayScene_when_Loaded_then_SlingshotPrelaunchCompositionIsReady()
    {
        ...
        Assert.That(runSurfaceStabilityConfig.SupportLossConfirmationSeconds, Is.EqualTo(0.12f).Within(0.0001f));
        ...
        Assert.That(runSteeringFrameConfig.NormalSlewDegreesPerSecond, Is.EqualTo(120f).Within(0.0001f));
        Assert.That(runSteeringFrameConfig.AirborneUpRetentionSeconds, Is.EqualTo(0.12f).Within(0.0001f));
