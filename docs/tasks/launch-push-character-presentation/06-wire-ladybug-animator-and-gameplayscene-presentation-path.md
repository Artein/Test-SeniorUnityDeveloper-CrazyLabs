...
- [ ] LaunchPush enters immediately after accepted launch and does not route through Slide or Run.
- [ ] LaunchPush hands off through a short clean transition after the classifier stops selecting LaunchPush.
- [ ] Slide and Run cannot appear during the launch-push guard window when the runtime mode is LaunchPush.
...
- Manual Unity smoke check:
  ...
  - Release a valid launch and confirm LaunchPush appears before Slide, Run, or Airborne can take over.
  - Confirm the previous early Slide and awkward Slide-to-Run leg-split moment is no longer visible during the slingshot push interval.
