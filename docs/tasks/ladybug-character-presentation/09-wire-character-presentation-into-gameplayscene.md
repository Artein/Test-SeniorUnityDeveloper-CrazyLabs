...
Wire the generic Character presentation system and the project-owned Ladybug Character prefab into Gameplay Scene. The Launch Target should continue to be the only gameplay physics authority while Character presentation follows it through Idle, Slide, Run, Airborne, Victory, and Defeat presentation modes.
...
- [ ] Active grounded flat forward movement can map to Run presentation.
...
- PlayMode tests:
  ...
  - Scenario smoke tests cover pre-launch Idle, active Slide, flat Run when practical, Airborne after debounce, Victory, and Defeat presentation signals.
